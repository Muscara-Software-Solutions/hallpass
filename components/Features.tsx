    ...
    <div class="bg-white py-24 sm:py-32">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:text-center">
          <h2 class="text-base font-semibold leading-7 text-indigo-600">Comprehensive Features</h2>
          <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Everything you need to monitor your halls</p>
          <p class="mt-6 text-lg leading-8 text-gray-600">With Hallpass's wide variety of comprehensive features, managing your students hallway privilages has never been so easy.</p>
        </div>

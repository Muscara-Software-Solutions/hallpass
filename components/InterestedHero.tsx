export default function InterestedHero() {
  return (
    <div
    ...
    >
      <div class="space-y-4 text-center">
        <h1 class="text-4xl inline-block font-bold">Interested in using <b class="font-bold text-blue-300">Hallpass</b>?</h1>
        <p class="text-xl max-w-lg text-blue-100">Click the button below to schedule a <b class="font-bold text-green-300">free</b> demo and estimate.</p>
      </div>
